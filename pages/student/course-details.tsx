    ...
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-brand-100 via-brand-200 to-brand-300 p-4">
        {courseDetail.map((courseDetails) => (
          <div
            ...
            className="max-w-screen-lg mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8  p-4 "
          >
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-brand-100 p-4">
            ...
            <div className="bg-transparent border border-gray-300 rounded p-4">
              ...
              <div className="bg-gradient-to-r from-brand-300 via-brand-200 to-brandazul-200 border-gray-300 rounded p-4 mt-10">
                <img
                  ...
                  alt="Module icon"
                />
                <text className="text-white text-sm lg:text-base">
        ...
        {Array.isArray(coursesMaterials) && coursesMaterials.length > 0 ? (
          <div className="py-12 md:py-20 bg-brand-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-brand-100">
        ...
        <div className="items-center justify-center bg-gradient-to-r  from-brand-100 via-brand-200 to-brand-300 pb-20 px-4 lg:px-60">
          <h1 className="text-2xl lg:text-3xl font-bold mb-4 text-white pt-20">
            Temario
          </h1>
          {courseDetail.map((courseDetails) => (
          ...
          <div className="items-center justify-center bg-gradient-to-r border-2 border-brandblanco-200 rounded from-brand-100 via-brand-200 to-brand-300 p-4">
            {courseDetail.map((courseDetails) => (
              <div
                key={courseDetails.course_id}
                className="max-w-screen-lg mx-auto grid grid-cols-1 lg:grid-cols-1 gap-8 p-4"
              >
                <div className="text-white">
                  <div className="flex items-center">
                    <img
                  ...
                  {courseDetails.presentation_professor && (
                    <div className="mt-4">
                      ...
                      >
                        <source
                          src={courseDetails.presentation_professor}
                          type="video/mp4"
                        />
                      </video>
                    </div>
