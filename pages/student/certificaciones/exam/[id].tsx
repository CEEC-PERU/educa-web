      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">{certification.description}</p>
          </div>
          {/* Stats Grid */}
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-yellow-800 mb-2">
                  Asegúrate de leer todas las instrucciones antes de comenzar el
                  examen.
                </h3>
          ...
          <div className="space-y-3 mb-8">
            ...
            {currentQuestion.type_id !== 1 && (
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded text-yellow-800">
                <p>
                  Tipo de pregunta ({currentQuestion.type_id}) no renderizado en
                  esta vista.
                </p>
              </div>
            )}
...
TakeCertificationExam.getLayout = (page: React.ReactNode) => (
