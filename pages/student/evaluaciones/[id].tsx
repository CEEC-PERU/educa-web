      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">{evaluation.description}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-lg font-semibold text-gray-900">
                {evaluation.passing_score} de {evaluation.total_points} puntos
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <ul className="text-yellow-700 text-sm space-y-1">
                  ...
                  <li>
                    • Para preguntas de selección múltiple, puedes elegir más de
                    una opción
                  </li>
                  <li>
        ...
        <div className="container mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">
              ...
              {evaluation.questions.length} • Respondidas: {getAnsweredCount()}/
              {evaluation.questions.length}
            </p>
          </div>
        ...
        <div className="mt-4">
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              ...
              style={{
                width: `${
                  ((currentQuestionIndex + 1) / evaluation.questions.length) *
                  100
                }%`,
              }}
            ></div>
...
TakeEvaluation.getLayout = (page: React.ReactNode) => (
