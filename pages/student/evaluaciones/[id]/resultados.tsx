          ...
          <div className="text-center">
            {results.passed ? (
              ...
              <div className="mb-4">
                ...
                <p className="text-red-600">Necesitas mejorar tu puntuación</p>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Porcentaje obtenido</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Minutos utilizados</div>
              </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-gray-600">
                        {question.user_answer.points_earned}/{question.points}{" "}
                        pts
                      </span>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="bg-gray-50 p-3 rounded text-sm">
                          {question.user_answer.answer_text || "Sin respuesta"}
                        </div>
                      </div>
