    ...
    <ProtectedRoute>
      <div className="w-full max-w-5xl">
        {questions.map((question, questionIndex) => (
          <div
            key={questionIndex}
            className="mb-6 pb-4 border-b p-4 rounded-md bg-gray-50"
          >
                  ...
                  <div>
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleOptionChange(e, questionIndex, 0)
                        }
                        className="mr-2"
                      />
                    </div>
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleOptionChange(e, questionIndex, 1)
                        }
                        className="mr-2"
                      />
                    </div>
                    ...
                    {question.options?.map((option, optionIndex) => (
                      <div key={optionIndex} className="ml-4 mt-2">
                        <input
                          ...
                          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                        <label className="block text-blue-600 text-sm font-bold mb-2 mt-4">
                          Correcta
                        </label>
                        <input
                ...
                {question.image && (
                  <div className="flex justify-center">
                    <img
                      src={question.image}
                      alt="Preview"
                      className="max-w-full h-64 object-contain rounded mb-4"
                    />
                  </div>
                )}
              </div>
                ...
                question.options.map((option, optionIndex) => (
                  <div key={optionIndex} className="flex items-center">
                    <p className="text-gray-700">
                      <strong>Opción {optionIndex + 1}: </strong>{' '}
                      {option.option_text}
                    </p>
                    <span
                      className={
