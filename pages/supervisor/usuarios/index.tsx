...
const Usuarios: React.FC = () => {
  ...
  const studentsWithProfile = filteredStudents.filter(
    (student) => student.User.userProfile
  );

  // Usuarios sin perfil
  const studentsWithoutProfile = filteredStudents.filter(
    (student) => !student.User.userProfile
  );
  ...
  const columnsWithoutProfile = [{ header: 'DNI', accessor: 'User.dni' }];
      ...
      <div className="flex flex-1 pt-16">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-8xl">
            <div>
              <h2 className="text-lg  mb-2  text-black font-semibold">
                Usuarios con Perfil
              </h2>
              <TableUser
