                      ...
                      {({ open }) => (
                        <>
                            ...
                            <div className="flex items-center space-x-2">
                              <div className="flex justify-between items-center mr-2">
                                <ButtonComponent
                                  ...
                                  buttonroute={`/supervisor/materials/module/addSession?moduleId=${module.module_id}`}
                          ...
                          <Disclosure.Panel className="text-m text-gray-700 px-6 py-4 rounded-b-lg">
                            ...
                            <hr className="my-4" />
                            <Link
                              href={`/supervisor/materials/module/evaluation/detailEvaluation?id=${module.evaluation_id}`}
                            >
