...
import { getUsersByEnterprise } from '../../services/users/userService';
...
const AdminPage: React.FC = () => {
  ...
  const [selectedEnterprise, setSelectedEnterprise] = useState<number | null>(
    null
  );
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                      touchedFields.startDate && !startDate
                        ? 'border-red-500'
                        : ''
                    }`}
                  />
                ...
                <div>
                  <input
                    ...
                    className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mt-6 ${
                      touchedFields.endDate && !endDate ? 'border-red-500' : ''
                    }`}
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <select
                  ...
                  className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                    touchedFields.selectedEnterprise && !selectedEnterprise
                      ? 'border-red-500'
                      : ''
                  }`}
                >
