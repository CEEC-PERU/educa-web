...
const CardImage: React.FC<CardImageProps> = ({
  ...
  return (
    <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-brandazul-600 bg-clip-border text-gray-700 shadow-lg mx-2 my-4">
      ...
      <div className="p-6">
        ...
        <p className="block font-sans text-base antialiased font-light leading-relaxed text-white text-center truncate">
          {displayDescription}
        </p>
