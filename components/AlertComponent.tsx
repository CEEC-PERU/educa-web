...
const Alert: React.FC<AlertProps> = ({ type = 'info', message, link, onClose }) => {
  ...
  return (
    <div className={`flex items-center p-4 mb-4 border-t-4 ${style} w-full`} role="alert">
      ...
      <div className="ml-3 text-sm font-medium w-full">
        {message}
      </div>
      <button 
        type="button" 
