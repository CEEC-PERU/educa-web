...
const SidebarPrueba: React.FC<SidebarProps> = ({
  courseModules,
  courseEvaluation,
  onSelect,
  videoProgress = {},
  ...
  const getSessionProgress = (
    ...
    const sessionProgress =
      session.find(
        (progress) =>
          progress.session_id === sessionId && progress.user_id === userInfo.id
      )?.progress || 0;
  ...
  return (
    <div className="bg-brand-500 text-white divide-y divide-neutral-100 h-full p-4 overflow-y-auto lg:w-96 lg:fixed lg:right-0 lg:top-16  pb-16 lg:h-full w-full">
          ...
          <div key={module.module_id} className="py-4">
            ...
            >
              {module.moduleEvaluation && (
                <div>
                  Evaluación del Módulo {moduleIndex + 1}:{' '}
      ...
      <div
        ...
        onClick={() =>
          allModulesCompleted && onSelect('', courseEvaluation.questions)
        }
      >
