...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen w-full p-6 text-center text-white">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-6xl mx-auto px-6">
          <div className="md:w-1/2 relative z-10 px-6 text-left md:mr-10">
            <h1 className="text-4xl md:text-5xl font-bold mb-2">La plataforma que fideliza a tu cliente</h1>
            <p className="text-lg md:text-xl mb-10">
              Descubre la revolución que cambiará la forma en que educas y conectas con tu audiencia. La personalización completa es la clave para una experiencia de aprendizaje inigualable. Somos el puente entre tu marca y la educación. Únete al futuro de la fidelización.
            </p>
          ...
          <div className="md:w-1/2 relative z-10 px-20 mt-10 md:mt-0">
      ...
      <section className="relative  items-center justify-center w-full p-6 text-center text-white" style={{ backgroundColor: '#7C3AED' }}>
      ...
      <section className="relative flex flex-col items-center justify-center  w-full p-6 text-center text-white">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(https://source.unsplash.com/random/1600x900)' }}>
          <div className="absolute inset-0 bg-gradient-to-r from-brand-100 via-brand-200 to-brand-300"></div>
        </div>
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-6xl mx-auto px-6 mt-20 mb-20">
          ...
          <p>Ofrecemos cursos de cañlidad , actualziados y elaborados por expertos en cada materia .Con recursos interactivos, lecciones dinámicas y evaluaciones prácticas, te proporcionamos las herramientas para adquirir habilidades y conocimientos de forma efectiva.</p>
      ...
      {/* Sección 5: Información adicional con otro fondo de imagen y gradiente  from-brand-300 via-brand-200 to-brand-100 */}
      <section className="relative  items-center justify-center w-full p-6 text-center text-white">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(https://source.unsplash.com/random/1600x900)' }}>
        ...
        <div className="relative z-10 container mx-auto p-6 bg-opacity-50 rounded shadow-lg">
          ...
          <p className="text-lg mb-4">En un mercado educativo lleno de opciones tu puedes sobresalir con una plataforma educativa unica, diseñada a la medida de tu marca . Atrae miradas, genera emoción y diferencia tu oferta de manera significativa. No solo atraerás a más usuarios, sino que los mantendrás comprometidos con una experiencia que no olvidarán.
</p>
