    ...
    <html lang="es" className="scroll-smooth">
      <Head>
        ...
        <meta
          ...
          content="Desarrolla habilidades clave con nuestros programas de formación profesional."
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dk2red18f/image/upload/v1724273464/WEB_EDUCA/smxqc1j66tbr0dkrxbdt.png"
        />
